...
likert_plot <- HH::likert(Killer ~ ., kills_distrib_perc, main="Distributions of the kills per killer", ylab= '', as.percent=TRUE, positive.order=TRUE, rightAxis = FALSE, par.settings = list(bg = "transparent"))
