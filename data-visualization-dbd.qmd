...
ggplot() +
  geom_bar(aes(x = dead_by_daylight$`# Escaped Survivors`), fill = "#CC0000") +
...
ggplot() +
geom_bar(aes(x = DbD_5gens$`# Escaped Survivors`), fill = "#CC0000") +
...
dead_by_daylight |> 
ggplot() +
geom_bar(aes(x = dead_by_daylight$`# Finished generators`, fill = SBMM)) +
facet_wrap(~SBMM) +
...
dead_by_daylight |> 
ggplot() +
geom_bar(aes(x = dead_by_daylight$`# Escaped Survivors`, fill = SBMM)) +
facet_wrap(~SBMM) +
...
```{r}
ggplot() +
  geom_bar(aes(y = fct_infreq(dead_by_daylight$Killer)), fill = "#CC0000") +
  guides(fill = 'none') +
...
```{r}
ggplot() +
  geom_bar(aes(y = fct_infreq(dead_by_daylight$Map)), fill = "#CC0000") +
  guides(fill = 'none') +
...
ggplot() +
  geom_bar(aes(x = dead_by_daylight$gate_escapes), fill = "#CC0000") +
...
ggplot() +
  geom_bar(aes(x = dead_by_daylight$`# Hatch escapes` ), fill = "#CC0000") +
...
dead_by_daylight |> 
ggplot() +
geom_bar(aes(y = fct_infreq(Killer) , fill = dead_by_daylight$`# Hatch escapes`), fill = "#CC0000") +
#facet_wrap(~Killer) +
...
dead_by_daylight |> 
ggplot() +
geom_bar(aes(y = fct_infreq(Map) , fill = dead_by_daylight$`# Hatch escapes`), fill = "#CC0000") +
#facet_wrap(~Killer) +
...
ggplot(dead_by_daylight, aes(x = `# Finished generators`, y = `# Escaped Survivors`)) +
  geom_point() +
  geom_smooth(method = "lm", formula = 'y ~ x', se = FALSE, colour = "#CC0000") +
...
#dbd_1 <- ggplot(dead_by_daylight, aes(Map, Killer)) +
  #geom_raster(aes(fill = dead_by_daylight$`# Escaped Survivors`)) +
