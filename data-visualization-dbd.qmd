...
killer_performance_plot <- killer_perf |> 
  ggplot() +
  geom_bar(aes(x = kill_rate, y = fct_infreq(Killer, kill_rate)), fill = "#9C2A23", stat = "identity", position = "dodge") +
  labs(title = "Killer performances", x = "Average of killed survivors", y = '') 

grid.arrange(pick_rate_plot, killer_performance_plot, ncol=2)

## add geom_text with the numbers inside of the bars
